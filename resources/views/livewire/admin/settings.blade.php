<div class="space-y-6">
    ...
    <x-card title="Configurações da Mega-Sena" class="max-w-2xl">
        <div class="space-y-6">
            ...
            <div>
                <x-input label="Quantidade de Números a Escolher" wire:model="numbersToPickProperty" type="number"
                    min="1" max="20"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <x-input label="Número Mínimo" wire:model="minNumberProperty" type="number" min="1"
                        hint="Número inicial (ex: 1)" />
                </div>

                <div>
                    <x-input label="Número Máximo" wire:model="maxNumberProperty" type="number" min="1"
                        max="100" hint="Número final (ex: 60)" />
                </div>
            </div>
            ...
            <x-alert color="blue" class="mt-6">
                <div class="space-y-2">
                    ...
                    <p class="text-sm">
                        ...
                        <strong>{{ $maxNumberProperty - $minNumberProperty + 1 }}</strong>
                    </p>
                </div>
            </x-alert>
            ...
            <div class="flex justify-between gap-4 pt-4">
                <x-button wire:click="loadSettings" color="slate" icon="arrow-path">
                    Resetar
                </x-button>

                <x-button wire:click="save" color="green" icon="check-circle" wire:loading.attr="disabled">
